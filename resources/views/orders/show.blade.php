                        ...
                        @if ($order->order_status === \App\Enums\OrderStatus::PENDING)
                            <div class="dropdown">
                                <a href="#" class="btn-action dropdown-toggle" data-bs-toggle="dropdown"
                                    aria-haspopup="true"
                                    aria-expanded="false"><!-- Baixar ícone SVG de http://tabler-icons.io/i/dots-vertical -->
                                ...
                                <div class="dropdown-menu dropdown-menu-end" style="">
                                    <form action="{{ route('orders.update', $order->uuid) }}" method="POST">
                                        ...
                                        <button type="submit" class="dropdown-item text-success"
                                            onclick="return confirm('Tem certeza de que deseja aprovar este pedido?')">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered align-middle">
                            <thead class="thead-light">
                                <tr>
                                    <th scope="col" class="align-middle text-center">Nº.</th>
                                    <th scope="col" class="align-middle text-center">Foto</th>
                                    <th scope="col" class="align-middle text-center">Nome do Produto</th>
                                    <th scope="col" class="align-middle text-center">Código do Produto</th>
                                    <th scope="col" class="align-middle text-center">Quantidade</th>
                                    <th scope="col" class="align-middle text-center">Preço</th>
                    ...
                    @if ($order->order_status === \App\Enums\OrderStatus::PENDING)
                        <form action="{{ route('orders.update', $order->uuid) }}" method="POST">
                            ...
                            <button type="submit" class="btn btn-success"
                                onclick="return confirm('Tem certeza de que deseja concluir este pedido?')">
                                {{ __('Concluir Pedido') }}
                            </button>
                        </form>
                    @endif
