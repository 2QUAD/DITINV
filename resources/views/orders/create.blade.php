                                ...
                                <table class="table table-striped table-bordered align-middle">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th scope="col" class="text-center">{{ __('Quantidade') }}</th>
                                            <th scope="col" class="text-center">{{ __('Preço') }}</th>
                                        ...
                                        <tr>
                                                ...
                                                <form action="{{ route('pos.updateCartItem', $item->rowId) }}" method="POST">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-append text-center">
                                                            <button type="submit" class="btn btn-icon btn-success border-none" data-toggle="tooltip" data-placement="top" title="" data-original-title="Enviar">
                                            ...
                                            <td class="text-center">
                                                <form action="{{ route('pos.deleteCartItem', $item->rowId) }}" method="POST">
                                                    @method('delete')
                                                    @csrf
                                                    <button type="submit" class="btn btn-icon btn-outline-danger " onclick="return confirm('Tem certeza que deseja excluir este registro?')">
