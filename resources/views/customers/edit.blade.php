                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row row-cards">
                                        <div class="col-md-12">
                                            ...
                                            <x-input label="Endereço de E-mail" name="email" :value="old('email', $customer->email)"
                                                :required="true" />
                                        </div>

                                        <div class="col-sm-6 col-md-6">
                                            <x-input label="Número de Telefone" name="phone" :value="old('phone', $customer->phone)"
                                                :required="true" />
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <x-input label="Titular da Conta" name="account_holder" :value="old('account_holder', $customer->account_holder)"
                                                :required="true" />
                                        </div>

                                        <div class="col-sm-6 col-md-6">
                                            <x-input label="Número da Conta" name="account_number" :value="old('account_number', $customer->account_number)"
                                                :required="true" />
                                        </div>
