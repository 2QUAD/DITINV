...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/transfers/create', [OrderController::class, 'createTransfer'])->name('transfers.create');
    Route::post('/transfers', [OrderController::class, 'storeTransfer'])->name('transfers.store');
